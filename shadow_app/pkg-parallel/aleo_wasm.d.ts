...
*/
  estimateExecutionFee(private_key: PrivateKey, program: string, _function: string, inputs: Array<any>, url: string, cache: boolean, proving_key?: ProvingKey, verifying_key?: VerifyingKey): Promise<bigint>;
/**
...
* @returns {Promise<bigint>}
*/
  estimateDeploymentFee(program: string, cache: boolean): Promise<bigint>;
/**
...
export interface InitOutput {
  ...
  readonly programmanager_estimateDeploymentFee: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0bfe29e368864a44: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hdb7e33bdb2b880cf: (a: number, b: number, c: number, d: number) => void;
