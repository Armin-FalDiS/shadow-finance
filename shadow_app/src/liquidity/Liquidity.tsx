...
export const Liquidity = () => {
    ...
    const [liquidityTabState, setLiquidityTabState] = useState(LiquidiyTab.UserState)// a use effect is needed to get user state and then  set this accordingly and it needs wasm to work
    ...
    const handleSubmit = async (event: React.MouseEvent<HTMLElement>) => {
        ...
        if (requestRecords) {
            ...
            if (upperToken === Tokens.ArmInToken) {
                inputsArray = [publicKey, armInRecords[arminSpendableIndex], upperTokenAmount + "u64", armOutRecords[armOutSpendableIndex], lowerTokenAmount]

            }
            else if (upperToken === Tokens.ArmOutToken) {
                inputsArray = [publicKey, armInRecords[arminSpendableIndex], lowerTokenAmount + "u64", armOutRecords[armOutSpendableIndex], upperTokenAmount]
