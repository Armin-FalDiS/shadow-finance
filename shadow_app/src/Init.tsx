...
export const Init= () => {
  ...
  let [programId] = useState(app.shadow_swap.id);
  let [functionName] = useState(app.shadow_swap.init_function);

  let [fee] = useState(app.shadow_swap.init_fee);
  ...
  const handleSubmit = async (event: React.MouseEvent<HTMLElement>) => {
    ...
    if(requestRecords){
       ...
       const inputsArray = [publicKey,armInRecords[arminSpendableIndex],"1000u64",armOutRecords[armOutSpendableIndex],"2000u64"]
