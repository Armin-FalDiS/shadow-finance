...
export const MintArmOut  = () => {
  ...
  let [programId, setProgramId] = useState(app.armout_token.id);
  let [functionName, setFunctionName] = useState(app.armout_token.mint_function);
  let [inputs, setInputs] = useState("change this");  //this needs to change
  let [fee, setFee] = useState(app.armout_token.mint_fee);
